//attempt at making biography text transtion/animation in a cascading down format
  ...
  $(function( $ ){
    ...
    if(window.screen.width > 728){
     ...
     $(navBar).append(createCategory('/aboutme', 'About Me'))
